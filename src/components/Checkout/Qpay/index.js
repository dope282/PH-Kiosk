...
import background from "../../../assets/qpayBackground.png";
...
const Qpay = () => {
    ...
    return (
        <div className="flex justify-center items-center h-screen w-screen lg:text-5xl">
            ...
            >
                <div className="flex justify-end cursor-pointer p-6" onClick={() => navigate("/cage/checkout")}>
                    ⨉
                </div>
                <div className="flex justify-center text-gray-700 text-xl mt-5 lg:text-5xl">
                    Q-Pay уншуулан төлбөрөө төлнө үү
                </div>
                ...
                {error && (
                    <div
                        className={`bg-red-400 text-white mt-4 fixed top-3 left-1/2 -translate-x-1/2 p-2 px-5 rounded-lg lg:w-3/4 lg:text-center ${
